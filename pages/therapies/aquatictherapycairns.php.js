...
export default () => (
  <AppFrame pageTitle="Aquatic Therapy Cairns — Aguadulgent Massage Centre">
    <ContentHeading
      title="Aquatic Therapy Cairns"
      subtitle="Read more about our approach to aquatic therapy"
    />

    <Heading>A New World Of Ecstatic Wellbeing Awaits</Heading>
    <Paragraph>
      {`Practiced in warm water heated to 35Degrees Celsius, the same as skin temperature the following effects are common to all Modalities of the Water Massage Therapies practiced here.`}
    </Paragraph>
