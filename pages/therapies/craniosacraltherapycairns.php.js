...
export default () => (
  <AppFrame pageTitle="Craniosacral Therapy Cairns — Aguadulgent Massage Centre">
    <ContentHeading
      title="Craniosacral Therapy Cairns"
      subtitle="Read more about our approach to craniosacral therapy"
    />

    <Paragraph>
      {`CranioSacral Therapy (CST) is used to detect and correct imbalances in the craniosacral system, which may be the cause of sensory, motor or neurological dysfunction. The craniosacral system consists of the membranes and cerebrospinal fluid that surround and protect the brain and spinal cord. It extends from the skull, face and mouth - which make up the cranium- down to the sacrum , or tailbone area.`}
    </Paragraph>
    <Paragraph>
