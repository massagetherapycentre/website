...
export default () => (
  <AppFrame pageTitle="Sports Massage, Swedish Massage, plus more — Aguadulgent Massage Centre">
    <ContentHeading
      title="Synergistic Therapies"
      subtitle="Read more about our range of synergistic therapies"
    />

    <Heading>Sports Massage</Heading>
    <Paragraph>
      {`Sports Massage brings all the specialised therapies in massage together to firstly PREVENT injury. A Swedish style massage when applied to the athlete prior to activity, will warm, nourish and relax the muscles, and so far less injury is suffered.`}
    </Paragraph>
    <BulletList
      list={[
    ...
    <Paragraph>
      {` Aquatic Therapies/Bodywork/Massage are relatively new in Australia some modalities to be experienced at Practitoner competency include; `}
    </Paragraph>
    ...
    />
    <Paragraph>
      {`In a world of over 74,000 Chemicals, Increased pollution, heavy metals, and noxious fumes....YOU Need a Cleansing Strategy!`}
    </Paragraph>
    <Paragraph>
      {`<b>The Ion Flush Foot-Bath Energiser;</b>`}
    </Paragraph>
    <Paragraph>
      {`Those likely to benefit; Tired stressed people seeking an energy boost,smokers,drinkers,drug takers and party animals; those in poor health with low immunity; persons working in a polluted environment; those suffering arthritis, sports injury or gout; Diabetics- not type1 ; high blood pressure; prostrate problems and skin ailments; circulation problems.`}
    </Paragraph>
    <Paragraph>
      {`These Synergistic Therapies are located poolside, and are available individually or as part of a Synergistic Combination with other Therapies.`}
    </Paragraph>
