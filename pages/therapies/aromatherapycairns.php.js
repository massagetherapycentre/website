...
export default ({}) => (
  ...
  <Paragraph>{`<b>Internal</b>`}</Paragraph>
    <BulletList list={[
    ...
    <Paragraph>{`<b>They affect us in 3 different and overlapping ways;</b>`}</Paragraph>
    <BulletList list={[
